...
<html>
    <head>
        ...
        <title>Registrar Administravivo</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <caption>
                <div class="datos">
                    <div align="center" class="col-sm-12" style="background-color: #090B55"><h4 style="color:#FDFEFE">Registrar Usuario</h4></div>
            ...
            <form class="form-horizontal" action="Registro" >
                <div class="col-xs-6">
                    ...
                    <input type="text" class="form-control" id="grado" placeholder="Ingrese Gargo" name="cargo">
                </div>
                <div class="col-xs-6">
